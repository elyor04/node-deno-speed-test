...
URLS = [
    ...
    "http://localhost:3004",  # Deno
    "http://localhost:3007",  # Bun
    "http://localhost:3002",  # Node.js
    "http://localhost:3005",  # Deno
    "http://localhost:3008",  # Bun
    "http://localhost:3003",  # Node.js
    "http://localhost:3006",  # Deno
    "http://localhost:3009",  # Bun
]
